                ...
                {team.heads.map((head, index) => {
                  return (
                    <motion.div
                      ...
                      key={index}
                    >
                      <React.Suspense fallback={<div className='bg-[#272A57] w-48 h-48 rounded-3xl -mt-6 hover:scale-105 transition-all ease-in-out duration-150'></div>}>
                      ...
                      <p className='text-[#272A57] text-center mt-2 text-xl font-medium'>{head.name}</p>
                      <p className='text-[#272A57] text-center mt-1 text-sm font-normal opacity-80'>{head.post}</p>
                    </motion.div>
                  )
                })}
              </div>
